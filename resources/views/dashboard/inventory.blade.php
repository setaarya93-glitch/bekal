...
@section('sidebar')
    <nav class="space-y-1">
        <a href="{{ url('/dashboard/inventory') }}" class="flex items-center space-x-3 px-3 py-2 rounded-lg {{ request()->is('dashboard/inventory') && !request()->is('dashboard/inventory/*') ? 'bg-amber-50 text-amber-700 dark:bg-amber-900/50 dark:text-amber-300' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-gray-800' }}">
        ...
        <div class="pt-4 mt-4 border-t border-gray-200 dark:border-gray-700">
            ...
            <a href="{{ url('/dashboard/inventory/stock') }}" class="flex items-center space-x-3 px-3 py-2 rounded-lg {{ request()->is('dashboard/inventory/stock*') ? 'bg-amber-50 text-amber-700 dark:bg-amber-900/50 dark:text-amber-300' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-gray-800' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/></svg>
                <span>Stock (Opname)</span>
            </a>
        </div>

        {{-- Barang Movement Section --}}
        <div class="pt-4 mt-4 border-t border-gray-200 dark:border-gray-700">
            <p class="px-3 text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Pergerakan Barang</p>
            <a href="{{ url('/dashboard/inventory/masuk') }}" class="flex items-center space-x-3 px-3 py-2 rounded-lg {{ request()->is('dashboard/inventory/masuk*') ? 'bg-amber-50 text-amber-700 dark:bg-amber-900/50 dark:text-amber-300' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-gray-800' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"/></svg>
                <span>Barang Masuk</span>
            </a>
            <a href="{{ url('/dashboard/inventory/keluar') }}" class="flex items-center space-x-3 px-3 py-2 rounded-lg {{ request()->is('dashboard/inventory/keluar*') ? 'bg-amber-50 text-amber-700 dark:bg-amber-900/50 dark:text-amber-300' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-gray-800' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M9 19l3 3m0 0l3-3m-3 3V10"/></svg>
...
@section('header')
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Kelola stok barang dan gudang</p>
        </div>
...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 dark:text-white mt-2">2,847</p>
                    <p class="text-sm text-green-600 mt-1">+156 bulan ini</p>
                </div>
                <div class="w-12 h-12 bg-amber-100 dark:bg-amber-900/50 rounded-lg flex items-center justify-center">
                    <svg class="w-6 h-6 text-amber-600 dark:text-amber-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/></svg>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-600 dark:text-gray-400">Nilai Stok</p>
                    <p class="text-3xl font-bold text-gray-900 dark:text-white mt-2">Rp 450M</p>
                    <p class="text-sm text-blue-600 mt-1">+8% naik</p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-red-600 dark:text-red-400 mt-2">23</p>
                    <p class="text-sm text-red-600 mt-1">Perlu restock</p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 dark:text-white mt-2">145</p>
                    <p class="text-sm text-green-600 mt-1">Hari ini</p>
                </div>
                <div class="w-12 h-12 bg-green-100 dark:bg-green-900/50 rounded-lg flex items-center justify-center">
                    <svg class="w-6 h-6 text-green-600 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"/></svg>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="mb-8 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl p-4">
        <div class="flex items-center space-x-3">
            ...
            <div>
                <h3 class="text-red-800 dark:text-red-300 font-semibold">Peringatan Stok Rendah</h3>
                <p class="text-sm text-red-600 dark:text-red-400">23 item memiliki stok di bawah minimum. Segera lakukan restock.</p>
            </div>
            <button class="ml-auto px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors text-sm">Lihat Detail</button>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-3">
                    <div class="relative">
                        <input type="text" placeholder="Cari barang..." class="pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent dark:bg-gray-700 dark:text-white">
                        <svg class="w-5 h-5 text-gray-400 absolute left-3 top-2.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
                    </div>
                    <select class="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent dark:bg-gray-700 dark:text-white">
            ...
            <table class="w-full">
                <thead class="bg-gray-50 dark:bg-gray-700">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">Min Stok</th>
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr>
                        <td class="px-6 py-4 text-sm font-medium text-gray-900 dark:text-white">BRG-{{ 1000 + $idx }}</td>
                        <td class="px-6 py-4">
                            <div class="flex items-center space-x-3">
                                ...
                                <span class="text-sm font-medium text-gray-900 dark:text-white">{{ $item }}</span>
                            </div>
                        </td>
                        <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">{{ ['Bahan Baku', 'Barang Jadi', 'Packaging'][rand(0, 2)] }}</td>
                        <td class="px-6 py-4 text-sm font-medium {{ $stock < $minStock ? 'text-red-600' : 'text-gray-900 dark:text-white' }}">{{ $stock }}</td>
                        <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-400">{{ $minStock }}</td>
                        <td class="px-6 py-4 text-sm text-gray-900 dark:text-white">Rp {{ number_format(rand(10, 100) * 1000, 0, ',', '.') }}</td>
                        <td class="px-6 py-4">
                            <span class="px-2 py-1 text-xs rounded-full {{ $stock < $minStock ? 'bg-red-100 text-red-700 dark:bg-red-900/50 dark:text-red-300' : 'bg-green-100 text-green-700 dark:bg-green-900/50 dark:text-green-300' }}">
                                {{ $stock < $minStock ? 'Stok Rendah' : 'Tersedia' }}
                            </span>
                        </td>
                        <td class="px-6 py-4">
                            <div class="flex space-x-2">
                                <button class="text-blue-600 hover:text-blue-700 text-sm">Edit</button>
                                <button class="text-green-600 hover:text-green-700 text-sm">+Stok</button>
                            </div>
                        </td>
                    </tr>
                    @endforeach
    ...
    <div class="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
            <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Barang Masuk Terakhir</h3>
            </div>
            <div class="p-6">
                <div class="space-y-4">
                    ...
                    <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                        ...
                        <span class="text-xs text-gray-500 dark:text-gray-400">{{ rand(1, 5) }} jam lalu</span>
                    </div>
                    @endforeach
                </div>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
            <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Barang Keluar Terakhir</h3>
            </div>
            <div class="p-6">
                <div class="space-y-4">
